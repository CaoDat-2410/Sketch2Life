...
- Material substitutes are typed as approved-substitute IDs but need per-record owner/domain confirmation.
- No real child data, classroom observation, accessibility study, localization QA, or longitudinal evidence exists.
- Kaggle/Lightning/Runpod are not used; AI-model testing belongs to other workstreams.
- Integration behavior for auth, session state, Gate B, persistence, and mobile remains unimplemented.
