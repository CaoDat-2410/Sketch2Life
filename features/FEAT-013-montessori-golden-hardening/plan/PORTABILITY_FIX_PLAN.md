...
- Preserve the legacy FEAT-002 fixture manifest while making its validator normalize line endings before checking the historical CRLF-based digests; no fixture/catalog data file is rewritten.
...
- `AC-PF-03`: FEAT-002 catalog/fixture data files and Git blobs remain untouched; only validator compatibility code/tests may change.
