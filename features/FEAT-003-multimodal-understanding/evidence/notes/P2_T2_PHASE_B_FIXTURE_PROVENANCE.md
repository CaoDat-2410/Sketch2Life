...
|---|---|---|---|
| `edge-tts` | `7.2.8` (exact-pinned, per explicit authorization) | Isolated local virtual environment (not published) | Installed via `pip install edge-tts==7.2.8`; `pip show edge-tts` confirms `Version: 7.2.8`. |
| `ffmpeg` (static, x64) | `N-126335-gb32f8d1c23-20260830`, `BtbN/FFmpeg-Builds` `ffmpeg-master-latest-win64-gpl` | Isolated local tool directory (not published) | Archive SHA-256 `3b7b7cabc0bb66eba45c40194dddb7287d249f3c7030b76973044e7f1cb71838`; extracted `ffmpeg.exe` SHA-256 `765c096588827ba21605e16446b0871be20f73a73c7700c3d5a677383bf24687`. |
