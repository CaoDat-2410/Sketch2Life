...
- P2-T1 D3-R2 performance/native-memory evaluation: isolated harness implemented and
  preflight-verified; formal exact-commit execution/evidence review remains open. Cohort B remains
  gated on owner review of the actual candidate images.
