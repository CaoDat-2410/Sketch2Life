...
_getrgb = ImageColor.getrgb
_getcolor = ImageColor.getcolor
...
ImageColor.getrgb = lambda value: _getrgb(_normalize_color(value))
ImageColor.getcolor = lambda value, mode: _getcolor(_normalize_color(value), mode)
