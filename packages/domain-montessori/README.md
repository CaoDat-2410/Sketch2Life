...
FEAT-013 adds a 20-activity Golden Activity v2 overlay for deeper integration fixtures. Those candidates are currently `PENDING_OWNER_REVIEW`, remain `production_eligible=false`, and do not replace the 100-record v1 baseline.
